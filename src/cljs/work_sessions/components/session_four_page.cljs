(ns work-sessions.components.session-four-page
  (:require
...
(defn session-four-page []
  (let [is-docs-visible? (subscribe [:proxy-viewer.docs/is-visible?])]
    (r/create-class
     { :component-did-mount #(dispatch [:ui.header/show-first-details-for-type :session-four])
      :display-name "session-four-page"
